...
import img from '../../assets/images/previewImages/aboutPrevImage.jpg'
  ...
  return (
    <section className="about">
      <div className="about__body">
        <PreviewMain 
          title="СПОРТИВНЫЙ КЛУБ ОЛИМП" 
          subtitle="Центр спортивной жизни в Краснопахорском. Более 10 лет воспитывает молодых спортсменов не только с Красной Пахры но и со всего ТиНАО."
          decorImage={img}
          />
        <AboutDescription /> 
        <AboutBanner />
